...
Это то, что я написал сам как отправную точку.
...
А это то, что мне сгенерировал товарищ Claude Opus на базе предыдущих частей моего отчёта. Внезапно очень недурно!
...
Исходные данные -- очень прикидочные, но для отправной точки сгодится.
...
Дальнейшее я делал с помощью Perplexity + Google Gemini 3 и пачки наводящих вопросов, исправив за AI некоторые огрехи. По итогу -- вроде база и почти без кринжа.
...
Это я тоже делал не без помощи Claude Opus с несколькими подсказками в стиле "самые большные боли, вроде хранения изображений в MS SQL, лечим первыми". Ну и поправил за ним кой-какие ошибки, какие нашёл.
